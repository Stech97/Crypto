...
const faq = [
	...
	},
	{
		...
		answer: "Anyone can participate, as long as you have an internet connection (to use our website) and access to a bitcoin wallet (to deposit and Withdraw your money). Also, please note we don’t accept people from the USA and Canada.",
	},
]
	...
	render() {
		...
		return(
			<div className={"content-whitebox " + (this.state.isOpened ? "faq-questions-tab" : "faq-questions-tab-closed")}>
				...
				<div className={this.state.isOpened ? "faq-questions-tab-answer" : "none"}>
					<p>{answer}</p>
				</div>
			</div>
		)
