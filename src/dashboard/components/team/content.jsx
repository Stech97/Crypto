...
const MemberLevelRow = ({obj: { boxclass, level, members, total_invested, profits_paid, commission, total_earned }}) => {
	return(
		<div className={"team-table-content-row team-table-content-row-"+boxclass }>
			<h5 className="team-table-content-row-l gray-text">
				{ "Level " + level }
			</h5>
			<h5 className="team-table-content-row-m gray-text">
				{ members }
			</h5>
