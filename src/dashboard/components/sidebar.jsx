...
class SidebarBar extends Component {
	render() {
		...
		return (
			<NavLink
				activeClassName={
					"sidebar-bar-selected sidebar-bar" + isClosed + "-selected"
				}
				to={"/account/" + path}
				className={cn(
					"sidebar-" + name.toLowerCase(),
					cn("sidebar-bar" + isClosed)
				)}
			>
				<svg
					className={cn("sidebar-bar-icon")}
				...
				<svg
					className={cn("sidebar-bar-arrow")}
					preserveAspectRatio="xMinYMid slice"
					viewBox="0 -10 350 75"
				>
