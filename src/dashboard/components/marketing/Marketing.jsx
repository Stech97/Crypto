	...
	render() {
		return(
			<div className="marketing-box">
				<h5 className="marketing-business-header marketing-header">Business Presentation</h5>
				...
				<h5 className="marketing-video-header marketing-header">Video Presentation</h5>
				...
				<div className="marketing-follow">
					...
					<svg viewBox="0 0 32 22" preserveAspectRatio="xMinYMid slice" className="marketing-follow-icon-news marketing-follow-icon">
						<use href="#followus-news"/>
					</svg>
					<h5 className="marketing-follow-news">Subscribe to our Newsletter</h5>
					<div className="marketing-follow-icon-blog marketing-follow-icon">
						<img src="/img/followus-blog-icon.png" alt="followus-blog-icon"/>
					</div>
					<h5 className="marketing-follow-blog">Subscribe our Blog</h5>
					<svg viewBox="0 0 31 31" preserveAspectRatio="xMinYMid slice" className="marketing-follow-icon-telegram marketing-follow-icon">
						<use href="#followus-telegram"/>
					</svg>
					<h5 className="marketing-follow-telegram">Join our Telegram News Channel</h5>
				</div>
				<h5 className="marketing-facebook-header marketing-header">Social Media Posts</h5>
				...
				<h5 className="marketing-promopictures-header marketing-header">Promo Pictures </h5>
				...
				<h5 className="marketing-promovideos-header marketing-header">Promo Videos</h5>
