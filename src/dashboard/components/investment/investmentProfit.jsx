    ...
    return (
      <div className="investment-profit">
        ...
        <div className="investment-profit-content">
          <h3 className="investment-profit-content-header-1">Investment</h3>
          ...
          <h3 className="investment-profit-content-header-2">Product</h3>
          <div className="investment-profit-content-box-2">
            <select name="investment" size="1" value={this.state.product}>
